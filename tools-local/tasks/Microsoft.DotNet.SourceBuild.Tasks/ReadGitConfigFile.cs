...
namespace Microsoft.DotNet.Build.Tasks
{
    public class ReadGitConfigFile : Task
    {
        ...
        /// SourceBuildAutoUpdate = value of the "sourceBuildAutoUpdate" variable, or empty string
        /// </summary>
        [Output]
        ...
        public override bool Execute()
        {
            ...
            SubmoduleConfiguration = options
                ...
                .Select(g =>
                {
                    ...
                    // "git --list" converts entries to lowercase, but camelCase is standard for config names.
